...
$sql = "SELECT partNote, partNumber, partName, revisionId, customerId, materialSpecId, materialSpecDetail, PVC, x, y, itemWeight, itemArea, itemLength, itemWidth, itemHeight, treatmentId FROM cadcam_parts WHERE partId = ".$_GET['partId']." ";
                ...
                <div class="col-md-12">
                    <table class = 'table table-condensed table-bordered table-striped'>
                        <thead class='w3-indigo' style='text-transform:uppercase;'>
                            <th class = 'theadname' colspan = '2'><center><?php echo displayText('L64'); ?></center></th>
                        </thead>
                        <tbody>
                            <tr>
                                <td class = 'tname'><?php echo displayText('L24'); ?></td>
                                <td class = 'tresult'><?php echo $getCustomerResult['customerName']; ?></td>
                            </tr>
                            
                            <tr>
                                <td class = 'tname'><?php echo displayText('L28'); ?></td>
                                <td class = 'tresult'><?php echo $partsQueryResult['partNumber']; ?></td>
                            </tr>
                            
                            <tr>
                                <td class = 'tname'><?php echo displayText('L30'); ?></td>
                            ...
                            <tr>
                                <td class = 'tname'><?php echo displayText('L70'); ?>&emsp;&emsp;&emsp;&emsp;<font color=green>mm</font></td>
                                <td class = 'tresult'><?php echo $partsQueryResult['x']; ?></td>
                            </tr>
                        
                            <tr>
                                <td class = 'tname'><?php echo displayText('L71'); ?>&emsp;&emsp;&emsp;&emsp;<font color=green>mm</font></td>
                                <td class = 'tresult'><?php echo $partsQueryResult['y']; ?></td>
                            </tr>
                            
                            <tr>
                                <td class = 'tname'><?php echo displayText('L72'); ?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<font color=green>g</font></td>
                                <td class = 'tresult'><?php echo $partsQueryResult['itemWeight']; ?></td>
                            </tr>
                            
                            <tr>
                                <td class = 'tname'><?php echo displayText('L73'); ?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<font color=green>dm2</font></td>
                                <td class = 'tresult'><?php echo $partsQueryResult['itemArea']; ?></td>
                            </tr>
                            
                            <tr>
                                <td class = 'tname'><?php echo displayText('L74'); ?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<font color=green>mm</font></td>
                                <td class = 'tresult'><?php echo $partsQueryResult['itemLength']; ?></td>
                            </tr>
                            
                            <tr>
                                <td class = 'tname'><?php echo displayText('L75'); ?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<font color=green>mm</font></td>
                                <td class = 'tresult'><?php echo $partsQueryResult['itemWidth']; ?></td>
                            </tr>
                            
                            <tr>
                                <td class = 'tname'><?php echo displayText('L76'); ?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<font color=green>mm</font></td>
            ...
            <div class="col-md-12">
                <table class='table table-condensed table-bordered table-striped'>
                    <thead class='' style='text-transform:uppercase;'>
                        ...
                        $processColor = ($getPartProcessColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$processColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=process".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L59')."</a></th>";
                        ...
                        $subpartsColor = ($getSubPartsColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$subpartsColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=subparts".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L88')."</a></th>";
                        
                        $sql = "SELECT childId FROM cadcam_subparts WHERE parentId = ".$_GET['partId']." AND identifier = 2 ";
                        $getChildIdColor = $db->query($sql);
                        $childColor = ($getChildIdColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$childColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=accessories".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L471')."</a></th>";
                                            
                        $sql = "SELECT subpartId FROM cadcam_subparts WHERE parentId = ".$_GET['partId']." AND identifier = 8 ";
                        $getSuppliesIdColor = $db->query($sql);
                        $suppliesColor = ($getSuppliesIdColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$suppliesColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=supplies".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L470')."</a></th>";
                                            
                        $sql = "SELECT parentId FROM cadcam_subparts WHERE childId = ".$_GET['partId']." AND identifier = 1 ";
                        $getParentIdColor = $db->query($sql);
                        $parentColor = ($getParentIdColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$parentColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=mainparts".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L90')."</a></th>";
                        
                        $sql = "SELECT subconId, processCode FROM cadcam_subconlist WHERE partId = ".$_GET['partId']." ";
                        $getSubconListColor = $db->query($sql);
                        $subconColor = ($getSubconListColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$subconColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=subcon".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L91')."</a></th>";
                        
                        $sql = "SELECT partId FROM engineering_programs WHERE partId = ".$_GET['partId']." ";
                        $getProgramsColor = $db->query($sql);
                        $programColor = ($getProgramsColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$programColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=programs".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L92')."</a></th>";

                        $sql = "SELECT partId FROM engineering_partstandard WHERE partId = ".$_GET['partId']." ";
                        $getSpecificationColor = $db->query($sql);
                        $specificationColor = ($getSpecificationColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$specificationColor."'><a class='' style='text-decoration:none;' href = 'anthony_editProduct2.php?partId=".$_GET['partId']."&src=specifications".$pendingLocation."&patternId=".$_GET['patternId']."'>".displayText('L1360')."</a></th>";
                        
                        $sql = "SELECT toollistId FROM engineering_toollist WHERE partId = ".$_GET['partId']." ";	
                        $getToolListColor = $db->query($sql);
                        $toolColor = ($getToolListColor->num_rows > 0) ? "" : "w3-pink";
                        echo "<th class='w3-center ".$toolColor."'><a onclick = \"window.open('../toollistTPP/toolistInputform.php?partId=".$_GET['partId']."&TOOLLIST=Make+TOOL+LIST', '_blank', 'width=1150,height=650,status=yes,resizable=yes,scrollbars=yes')\">".displayText('L93')."</a></th>";
                                ...
                                while($getPartProcessResult = $getPartProcess->fetch_array())
                                {
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td class = 'tresult'>";
                                            ...
                                            echo "</ul>";
                                            ?>
                                                <a onclick="openTinyBox('250','300','carlo_addToolForm.php?partId=<?php echo $_GET['partId'];?>&processCode=<?php echo $getPartProcessResult['processCode']; ?>')"><img src = '../Common Data/Templates/images/add1.png' width = '20' height = '20' align='right'></a>
                                            <?php		
                                            if($toolCounter>0)
                                            {
                                            ?>
                    ...
                    echo "<table class='table table-condensed table-bordered table-striped'>";
                        ...
                        if($getSubParts->num_rows > 0)
                        {
                            while($getSubPartsResult = $getSubParts->fetch_array())
                            {
                                ...
                                echo "<tr>";
                                    echo "<td class = 'tresult' width = '231' ".$ifSubpartHasNoProcess."><a href = 'anthony_editProduct2.php?partId=".$getPartsResult['partId']."&src=process&patternId=".$_GET['patternId']."'>".$getPartsResult['partNumber']."</a></td>";
                ...
                else if($_GET['src'] == "programs")
                {
                    ...
                    if($getPrograms->num_rows > 0)
                    {
						if($howManyProgram>1)echo "<font size=5><a href='anthony_editProduct2.php?partId=".$_GET['partId']."&src=programs&patternId=".$_GET['patternId']."'>Select other program</a></font><br>";
					...
					else if($howManyProgram>1)
					{
						if($howManyProgram>1 and $_GET['programId']==0)
						{
							...
							{
								echo "<font size=5><a href='anthony_editProduct2.php?partId=".$_GET['partId']."&src=programs&patternId=".$_GET['patternId']."&programId=".$progIds[$duts]."'>".$progNames[$duts]."</a></font><br>";
							}									
						}
					}
                    else
                            ...
                            echo "<tbody>";
                                echo "<tr>";
                                    echo "<td class = 'tresult' width = '235'><center>".displayText('L104')."<br>";
                                        ...
                                        ?>
                                        <a onclick="TINY.box.show({url:'anthony_addProgramCodeForm.php?partId=<?php echo $_GET['partId']; ?>&patternId=<?php echo $_GET['patternId']; ?>',width:340,height:'',opacity:10,topsplit:6,animate:false,close:true})"><img src = '../images/add1.png' width = '25' height = '25'></a>
                                        <!---
