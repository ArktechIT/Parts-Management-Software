...
{
    $sql = "UPDATE cadcam_partsComment SET partsComment = '".$partComment."' WHERE commentId = '".$comId."'";
...
<body>
    <div class="container-fluid">
        <form action="jhon_partCommentEdit.php" method="post">
            <div class="row">
                <div class="col-12">
                    <input type="hidden" name="idCom" id="idCom" value="<?php echo $commentId; ?>">
                    <label>Part Comment</label>
                    <textarea type="text" name="partComment" id="partComment" cols="56" rows="10" style="resize:none;"><?php echo $partComment; ?></textarea>
                </div>
                <div class="col-auto text-center">
                    <button type="submit" name="btnEdit" class="w3-btn w3-round w3-indigo">Submit</button>
                </div>
            </div>
        </form>
    </div>  
