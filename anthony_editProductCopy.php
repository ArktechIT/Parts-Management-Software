                ...
                if($_GET['src'] == "process")
                {
                    ...
                    echo "<table class='table table-condensed table-bordered table-striped'>";
                        echo "<thead class='w3-indigo' style='text-transform:uppercase;'>";
                            ...
                            echo "<th style='vertical-align:middle;' class='w3-center'>NEW TOOLS</th>";
                            echo "<th style='vertical-align:middle;' class='w3-center'>MACHINE</th>";
                            echo "<th style='vertical-align:middle;' class='w3-center'>JIGS</th>";
	...
	TINY.box.show({
		...
		openjs:function(){		
			...
			$("#processName").change(function(){				
				$.ajax({
					url		: "anthony_addProcessDetailFormAjaxCopy.php",
					type	: "post",
...
function partsComment()
    ...
    {
        $("#modal-izi-update").iziModal({
            title                   : '<i class="fa fa-gear"></i>&nbsp;Machine',
            headerColor             : '#1F4788',
            subtitle                : '<b><?php //echo strtoupper(date('F d, Y'));?></b>',
            width                   : 400,
            fullscreen              : false,
            ...
            onOpening               : function(modal){
                                        ...
                                        // alert(assignedTo);
                                        $.ajax({
                                            url         : 'jhon_machineList.php',
                                            type        : 'POST',
                                            data        : {
                                                
                                                partId           :'<?php echo $_GET['partId'];?>',
                                                processCode      :'<?php $getPartProcessResult['processCode']; ?>',
                                                identifier       : 2,
