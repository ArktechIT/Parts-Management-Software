...
$sql = "SELECT * FROM cadcam_parts ".$sqlFilter;// if($_SESSION['idNumber'] == "0412") echo $sql;
$sqlData = $sql;
...
<form id='exportFormId' action='jhon_productAjax.php' method='POST'></form>
...
<script>
	$(function(){
        ...
        var dataTable = $('#mainTableId').DataTable( {
            ...
            "bInfo" : false,
            "ajax":{
                url     :"jhon_productAjax.php", // json datasource
